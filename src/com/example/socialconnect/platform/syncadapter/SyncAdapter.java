...
import com.example.socialconnect.platform.db.ContactManager;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
	...
	private static final String SYNC_MARKER_KEY = "com.linkedin.marker";
	...
	public void onPerformSync(Account account, Bundle extras, String authority,
		...
		try {
			...
			final String authtoken = mAccountManager.blockingGetAuthToken(account,
					SocialNetworkEnvironment.ENV_VAR_AUTHTOKEN_TYPE, NOTIFY_AUTH_FAILURE);
			...
			updatedContacts = SocialConnectAccessorFactory.getInstance().getSocialConnectAccessor()
					.syncContacts(mContext, account, authtoken, lastSyncMarker, dirtyContacts);
			...
			long newSyncState = ContactManager.updateContacts(mContext, account.name,
					updatedContacts, groupId, lastSyncMarker);
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) {
				ContactManager
						.addStreamItems(mContext, updatedContacts, account.name, account.type);
			}
