...
public class ContactManager {
     ...
     */
    public static final String CUSTOM_IM_PROTOCOL = "LinkedInConnect";

    private static final String TAG = "ContactManager";

    public static final String SAMPLE_GROUP_NAME = "LinkedInConnect Group";
    ...
    public static void addStreamItems(Context context, List<RawContact> rawContacts,
        ...
        String message = "via LinkedInConnect";
        for (RawContact rawContact : rawContacts) {
    ...
    public static void setAccountContactsVisibility(Context context, Account account,
        ...
        values.put(RawContacts.ACCOUNT_TYPE, SocialNetworkEnvironment.ENV_VAR_ACCOUNT_TYPE);
    ...
    private static void updateContactStatus(Context context, RawContact rawContact,
        ...
        final String userId = rawContact.getServerContactId();
    ...
    /**
     * SocialNetworkEnvironment for a query to find a contact given a sample SyncAdapter user
     * ID.
     */
    ...
    final private static class UserIdQuery {
        ...
        public static final String SELECTION =
            RawContacts.ACCOUNT_TYPE + "='" + SocialNetworkEnvironment.ENV_VAR_ACCOUNT_TYPE + "' AND "
                + RawContacts.SOURCE_ID + "=?";
    }

    /**
     * SocialNetworkEnvironment for a query to find SampleSyncAdapter contacts that are
    ...
    /**
     * SocialNetworkEnvironment for a query to get contact data for a given rawContactId
     */
    ...
    /**
     * SocialNetworkEnvironment for a query to read basic contact columns
     */
